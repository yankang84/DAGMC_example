...
def load_reflecting_wedge(input_location_wedge):
  ...
  return surface_info_dict, new_vols[0]
...
def find_reflecting_surfaces(surface_info_dict,wedge_volume):
...
wedge_surface_info_dict, wedge_volume = load_reflecting_wedge(input_location_wedge="reflecting_wedge.stp")
...
updated_wedge_surface_info_dict = find_reflecting_surfaces(wedge_surface_info_dict,wedge_volume)
print('wedge_surface_info_dict',wedge_surface_info_dict)
print('wedge_volume',type(wedge_volume),wedge_volume)
...
cubit.cmd('export dagmc "geometry_with_material_tags.h5m" faceting_tolerance 1.0e-2') # change to 1.0e-4 for accurate simulations
